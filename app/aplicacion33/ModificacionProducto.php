...
if(isset($_POST["codigo_de_barra"]) && isset($_POST["nombre"]) && isset($_POST["tipo"]) && isset($_POST["stock"]) && isset($_POST["precio"]))
{
    ...
    $resultado = Producto::ValidarProductoBd($codigo_de_barra);

    if($resultado == 1 && Producto::ModificarProductoBd($producto)) {
        ...
        echo "No se pudo hacer la modificación";
    }
}
else
{
    echo "No se ingresó producto";
}
